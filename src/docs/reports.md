...
## 3. Chart Bar Sub-activity (CBSA)

For detailed progress visualization on dashboards, each sub-activity is represented by two vertical bar charts.

### Chart 1: Done Work Percentage

This is a simple stacked bar chart showing overall completion.

*   **Green Bar:** Represents the percentage of work done.
    *   `value = (doneWork / totalWork) * 100`
*   **Gray Bar:** Represents the remaining work.
    *   `value = 100 - doneWorkPercentage`

### Chart 2: Detailed Grade Breakdown

This is a more detailed stacked bar chart that breaks down the work by quality grade and status.

*   **Green Bar (Grade A):** `value = (workGradeA / totalWork) * 100`
*   **Yellow/Orange Bar (Grade B):** `value = (workGradeB / totalWork) * 100`
*   **Red Bar (Grade C):** `value = (workGradeC / totalWork) * 100`
*   **Blue Bar (Pending):** `value = (pendingWork / totalWork) * 100`
*   **Gray Bar (Remaining):** `value = ((totalWork - doneWork - pendingWork) / totalWork) * 100`
